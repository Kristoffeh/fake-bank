...
<head>
    ...
    <title>Create an account - Brendy's</title>
            ...
            <div class="col-lg-12 col-xl-12 offset-lg-0 offset-xl-0" style="margin-top: 15px;">
                <div class="row">
                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                        ...
                        <h1 style="color: rgb(0,0,0);margin-top: 15px;">Create an account</h1>
                        <form id="register_form" name="form1" method="post">
                            <div class="form-group">
                            	...
                            	<small class="form-text text-muted" style="margin-top: 0px;">Please enter your first and lastname</small>
                                <input class="form-control register-textbox" type="text" style="transition: all 0.7s;" placeholder="Enter full name" name="name" id="name">
                            </div>

                            <div class="form-group"><label style="font-family: Roboto, sans-serif;color: #212121;font-size: 15px;margin-bottom: 5px;">
                            	<strong>E-mail Address</strong><br>
                            </label>
                            <small class="form-text text-muted" style="margin-top: 0px;">Please enter your personal e-mail address</small>
                                <input class="form-control register-textbox" type="email" placeholder="Enter e-mail address" style="transition: all 0.7s;" name="email" id="email">
                            </div>

                            <div class="form-group">
                            	<label style="font-family: Roboto, sans-serif;color: #212121;font-size: 15px;margin-bottom: 5px;">
                            	<strong>SSN</strong> (social security number)<br>
                            </label>
                            ...
                            <div class="form-group">
                            	<button class="btn btn-primary brendybtn-lightgreen" type="submit" style="margin-right: 15px;" name="btnreg" id="btnreg">Create</button>
                                <label>Already have an account?&nbsp;<a class="link-juicy" href="/login.php">Login</a></label>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-5 col-xl-5 offset-lg-1 offset-xl-0"><img class="rounded" src="/assets/img/velg_din_type_innlogging_jente_vind_i_haret_mobil_i_handen.jpg" width="400">
